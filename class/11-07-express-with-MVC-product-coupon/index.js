...
import { CashService } from "./mvc/controllers/services/point.js";
import { ProductService } from "./mvc/controllers/services/product.js";
const app = express();

// 이게 싱글톤이라고 하는데 global 또는 window 변수를 통해서도 만들 수 있지 않을까?
const prodectService = new ProductService();
const moneyService = new CashService();
// 상품 API
const productController = new ProductController(moneyService, prodectService); // 인스턴스라고 한다
...
// 쿠폰 API 
const couponController = new CouponController(moneyService, prodectService);
